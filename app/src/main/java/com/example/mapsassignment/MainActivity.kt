...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val uniz = arrayOf(
            "University Of Moratuwa", "University Of Colombo","University Of Kelaniya",
            "University Of Peradeniya", "University Of Sri Jayaeardanapura", "University Of Jaffna" ,"University Of Ruhuna",
        ...
        arrayAdapter = ArrayAdapter(this,
            android.R.layout.simple_list_item_1, uniz)
